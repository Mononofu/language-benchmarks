// Based on https://github.com/deepmind/open_spiel/blob/master/open_spiel/games/go/go_board.h
...
class GoBoard {
 public:
  ...
  inline Action VirtualActionToAction(int virtual_action) const {
    return ::VirtualActionToAction(virtual_action, board_size_);
  }
  inline int ActionToVirtualAction(Action action) const {
    return ::ActionToVirtualAction(action, board_size_);
  }
